...
// Ordena una lista de menor a mayor utilizando internamente un monticulo temporal
// Parámetro: puntero a la lista contigua a ordenar
// Precondiciones:
// - vector != NULL && n >= 0 && capacidad >= n (lista contigua es coherente)
