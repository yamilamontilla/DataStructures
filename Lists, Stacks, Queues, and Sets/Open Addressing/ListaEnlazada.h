...
// Estructura que representa a un estudiante (un elemento de la lista enlazada)
...
// Se trata de una lista enlazada de nodos, en donde cada nodo tiene un elemento (un Estudiante), 
...
Estudiante getValor(ListaEnlazada* lista, int posicion);
...
// - n>0 (lista no vacía)
// Complejidad temporal: O(n)
void setValor(ListaEnlazada* lista, int posicion, Estudiante nuevoValor);
...
// - posicion en [0, n]
// Complejidad temporal: O(n)
void insertar(ListaEnlazada* lista, int posicion, Estudiante nuevoValor);
...
// - lista != NULL && n >= 0 (la lista existe y su tamaño tiene sentido)
// Complejidad temporal: O(n)
int buscar(ListaEnlazada* lista, Estudiante elementoABuscar);
